...
(function(){
  var PRODUCTS = [
    ...
    ['DT4121','Aluminium Foil Tape — Acrylic (Heavy)','foil-sealing','acrylic','foil','single','Heavy-gauge aluminium foil, thermosetting acrylic — elevated temperature up to 150°C.'],
    ['DT4141','Aluminium Foil Tape — Hot Melt (Heavy)','foil-sealing','hotmelt','foil','single','Heavy-gauge aluminium foil, hot-melt — high bond strength for HVAC and industrial.'],
    ...
    ['DT6142','Double-Sided Tissue Tape — Hot Melt','bonding','hotmelt','tissue','double','Ultra-thin tissue (~70 µm) — hot-melt, high initial tack, precision bonding.'],
