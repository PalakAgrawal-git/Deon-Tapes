// DEON Tapes — Shared data (markets, applications, product names & specs)
(function() {
  'use strict';

  /* ================================================================
     PRODUCTS — full catalogue with real specs from datasheet pages
     ================================================================ */
  ...
  // Legacy SKUs referenced in market/application data but not in current catalogue
  var legacy = {
    '31900':'PVC Electrical Tape — Flame Retardant',
    'DT3221':'Acetate Cloth Tape',
    'DT5241':'Double-Sided Tissue Tape',
    'DT5341':'Double-Sided Film Tape',
    'DT4061':'Reinforced Aluminium Foil Tape',
    'M5002':'Masking Tape — High Temperature',
    'DT9251':'BOPP Packaging Tape — Hot Melt',
    'DT9351':'Printed BOPP Packaging Tape',
    'DT6121':'Surface Protection Film',
    'DT6221':'Stucco Masking Tape',
    'DT7111':'Filament Strapping Tape',
    'DT7211':'Cross-Weave Filament Tape',
    'DT8011':'Thermal Interface Tape',
    'DT8111':'Kapton Assembly Tape'
  };
  Object.keys(legacy).forEach(function(k) {
    if (!DEON_PNAME[k]) DEON_PNAME[k] = legacy[k];
  });

  /* ---- Product categories (family) ---- */
  window.DEON_PFAMILY = {};
  Object.keys(DEON_PRODUCTS).forEach(function(k) {
    DEON_PFAMILY[k] = DEON_PRODUCTS[k].family;
  });
  var legacyFam = {
    '31900':'Electrical & Insulation','DT3221':'Electrical & Insulation',
    'DT5241':'Bonding & Double-sided','DT5341':'Bonding & Double-sided',
    'DT4061':'Foil & Sealing','M5002':'Masking',
    'DT9251':'Packaging','DT9351':'Packaging',
    'DT6121':'Masking','DT6221':'Masking',
    'DT7111':'Packaging','DT7211':'Packaging',
    'DT8011':'Insulation','DT8111':'Insulation'
  };
  Object.keys(legacyFam).forEach(function(k) {
    if (!DEON_PFAMILY[k]) DEON_PFAMILY[k] = legacyFam[k];
  });

  /* ---- Markets ---- */
  window.DEON_MARKET_ORDER = [
    'transportation','electrical','building','renewable','metal',
    'hvacr','appliance','packaging','electronics','automotive','print'
  ];

  window.DEON_MARKETS = {
    transportation: {
      name: 'Transportation',
      intro: 'Tapes for rail, commercial vehicle and aerospace wiring, insulation and interior assembly — built for vibration, temperature cycling and long service life.',
      needs: [
        'Wire harness wrapping & bundling',
        'Interior trim & panel bonding',
        'Thermal & acoustic insulation',
        'Surface protection during transit',
        'Vibration damping & NVH control'
      ],
      products: ['50W13','DT5142','DT1111','DT3124L','DT1221H']
    },
    electrical: {
      name: 'Electrical',
      intro: 'The insulation backbone for motors, transformers, switchgear and coils — PVC, polyester, polyimide and glass-cloth constructions rated to the application class.',
      needs: [
        'Coil & layer insulation',
        'Motor & transformer winding',
        'Terminal & busbar insulation',
        'Wave-soldering & coil masking',
        'Cable identification & phasing'
      ],
      products: ['31700','DT1111','DT1113','DT1123','DT2131','DT3131','DT3121L']
    },
    building: {
      name: 'Building Components',
      intro: 'Sealing, bonding and insulation tapes for HVAC ducting, glazing, roofing and facade assembly — temperature-rated and weather-resistant.',
      needs: [
        'HVAC duct sealing & joining',
        'Glazing & curtain-wall bonding',
        'Vapour-barrier sealing',
        'Pipe & lagging insulation',
        'Surface protection during fit-out'
      ],
      products: ['DT4021','DT4041','DT5142','PW6001','M5001']
    },
    renewable: {
      name: 'Renewable Energy',
      intro: 'Tapes for solar-panel framing, wind-turbine blade bonding and battery-pack insulation — UV-stable, high-bond and dielectric.',
      needs: [
        'Solar module framing & backsheet bonding',
        'Wind-turbine blade edge protection',
        'Battery-pack insulation & cell wrapping',
        'Inverter & junction-box insulation',
        'Cable management in solar arrays'
      ],
      products: ['DT5142','DT2131','DT1111','DT4021','50W13']
    },
    metal: {
      name: 'Metal Manufacturing',
      intro: 'Surface protection, masking and marking tapes for steel, aluminium and coil processing — clean removal after forming, coating or cutting.',
      needs: [
        'Coil & sheet surface protection',
        'Powder-coat & anodising masking',
        'Slitting-line edge marking',
        'Temporary hold during forming',
        'Floor & aisle marking in mills'
      ],
      products: ['DT1231','M5001','41860','DT7143','DT3741L']
    },
    hvacr: {
      name: 'HVAC & Insulation',
      intro: 'Foil, cloth and PVC tapes for duct sealing, pipe lagging and insulation jacketing — rated for temperature, moisture and long-term adhesion.',
      needs: [
        'Rigid & flexible duct sealing',
        'Pipe & vessel lagging',
        'Insulation jacket closure',
        'Condensation barrier sealing',
        'Equipment identification marking'
      ],
      products: ['DT4021','DT4041','DT4121','DT4141','DT3131','PW6001']
    },
    appliance: {
      name: 'Appliance Manufacturing',
      intro: 'Insulation, harness and bonding tapes for white goods, small appliances and motor assemblies — produced to OEM specification and cosmetic standards.',
      needs: [
        'Motor & compressor winding',
        'Internal wire harnessing',
        'Component bonding & mounting',
        'Nameplate & label attachment',
        'End-of-line surface protection'
      ],
      products: ['31700','DT1111','50W13','DT5142','DT1142','DT1221H']
    },
    packaging: {
      name: 'Packaging & Logistics',
      intro: 'BOPP, filament and printed tapes for carton sealing, unitising, bundling and tamper evidence — high-speed line compatible.',
      needs: [
        'Carton sealing — manual & automatic',
        'Pallet unitising & strapping',
        'Bundling & collation',
        'Printed branding & tamper evidence',
        'Heavy-duty fibre-reinforced sealing'
      ],
      products: ['DT9151','DT7143','DT7243','DT3741L']
    },
    electronics: {
      name: 'Electronics',
      intro: 'Polyimide, polyester and foam tapes for PCB masking, component insulation, EMI shielding and device assembly — clean-room and ESD-safe grades.',
      needs: [
        'Wave & reflow solder masking',
        'Component & coil insulation',
        'Display & touchscreen bonding',
        'EMI / RFI shielding attachment',
        'Battery cell wrapping'
      ],
      products: ['DT2131','DT1231','DT5142','DT1142','DT1221H']
    },
    automotive: {
      name: 'Automotive',
      intro: 'Harness, insulation and bonding tapes for under-hood, interior and exterior automotive applications — OEM-qualified for temperature, vibration and ageing.',
      needs: [
        'Wire harness wrapping & noise damping',
        'Under-hood thermal insulation',
        'Interior trim & badge bonding',
        'Paint-line masking & surface protection',
        'EV battery-pack insulation'
      ],
      products: ['50W13','DT1111','DT5142','DT1231','DT2131']
    },
    print: {
      name: 'Print & Paper',
      intro: 'Splicing, core-starting and web-holding tapes for printing, converting and paper-processing lines — fast grab, clean release and precise positioning.',
      needs: [
        'Flying & zero-speed web splicing',
        'Core starting on winders',
        'Plate & blanket mounting',
        'Edge trim holding',
        'Roller wrapping & protection'
      ],
      products: ['DT6122','DT6142','DT1142','DT9151','M5001']
    }
  };
  ...
  window.DEON_APPLICATIONS = {
    masking: {
      name: 'Masking',
      intro: 'Low-tack masking that holds through paint, powder-coat and process heat, then releases clean with no residue.',
      notes: 'Available in paper, PET and cloth backings — temperature range from room-temperature painting to 200 °C industrial cure.',
      tapes: ['M5001','DT1231']
    },
    bundling: {
      name: 'Bundling & Harnessing',
      intro: 'PVC and PET tapes that bundle, wrap and protect wiring looms, harnesses and cable runs.',
      notes: 'Flame-retardant grades available. Conformable PVC for tight radii; PET for higher temperature and abrasion resistance.',
      tapes: ['50W13','31700','DT1111','DT1221H']
    },
    insulation: {
      name: 'Insulation',
      intro: 'Electrical insulation tapes rated from Class A to Class H — PVC, polyester, polyimide and glass cloth.',
      notes: 'Dielectric strength, thermal class and flammability ratings documented per product. UL-recognised grades available.',
      tapes: ['31700','DT1111','DT1113','DT1123','DT2131','DT3131','DT3121L']
    },
    bonding: {
      name: 'Bonding',
      intro: 'High-bond double-sided tapes that permanently join panels, trims, nameplates and structural components.',
      notes: 'PE foam for structural bonds; tissue and film carriers for lighter loads. Indoor and outdoor grades.',
      tapes: ['DT5142','DT1142','DT6122','DT6142','DT6041']
    },
    mounting: {
      name: 'Mounting',
      intro: 'Foam and film double-sided tapes for mounting signs, mirrors, fixtures and electronic components.',
      notes: 'PE foam, acrylic foam and thin-film options. Gap-filling and vibration-damping properties available.',
      tapes: ['DT5142','DT1142','DT6041']
    },
    protection: {
      name: 'Surface Protection',
      intro: 'Low-tack films and tapes that protect metal, glass and plastic surfaces during processing, transit and installation.',
      notes: 'Clean removal after extended application. UV-stable grades for outdoor exposure during construction.',
      tapes: ['DT1221H','M5001','DT3124L']
    },
    packaging: {
      name: 'Packaging',
      intro: 'BOPP and filament tapes for carton sealing, bundling and palletising — manual and automatic application.',
      notes: 'Acrylic and hot-melt adhesive systems. Printed and branded options. Compatible with high-speed case-sealing equipment.',
      tapes: ['DT9151','DT7143','DT7243','DT3741L']
    },
    'floor-and-safety-marking': {
      name: 'Floor & Safety Marking',
      intro: 'High-visibility PVC lane and safety marking that stays down under forklift and foot traffic, and lifts clean.',
      notes: 'Standard safety colours. Resistant to abrasion, chemicals and cleaning solvents.',
      tapes: ['41860']
    },
    'thermal-management': {
      name: 'Thermal Management',
      intro: 'Thermal interface tapes and high-temperature insulation for heat dissipation, shielding and protection.',
      notes: 'Polyimide, glass cloth and specialty constructions for applications up to 300 °C continuous.',
      tapes: ['DT2131','DT3131','DT3121L']
    },
    assembly: {
      name: 'Assembly',
      intro: 'Positioning, holding and joining tapes used during component assembly, sub-assembly and final build.',
      notes: 'Temporary and permanent bond options. Thin, conformable constructions for precise placement.',
      tapes: ['DT1221H','DT1142','DT6041']
    }
  };
